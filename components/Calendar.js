    ...
    <div className="flex flex-col gap-2">
      <div className="grid grid-cols-5 gap-4">
        <button
          ...
          className="mr-auto text-indigo-500 text-lg sm:text-xl duration-200 hover:opacity-60"
        >
          <i className="fa-solid fa-circle-chevron-left"></i>
        </button>
        <p
          className={
            'text-center capitalize textGradient col-span-3 ' + fugaz.className
          }
        >
          {selectedMonth},
        ...
        <button
          onClick={() => handleIncrementMonth(1)}
          className=" ml-auto text-indigo-500 text-lg sm:text-xl duration-200 hover:opacity-60"
        >
